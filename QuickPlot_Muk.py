...
# SIMPLE PLOT: Ionic trace (Top) Voltage Trace (Below)
...
# # # 3  Plot: Conductance-time (top), Voltage-time ON SAME graph  000 Check why noise level changes with voltage 0000
# for i,file in enumerate(filenames):
#     dat = LoadData.OpenFile(file)
#     fig1 = plt.figure(1, figsize=(8, 4))
#     ax_part1 = fig1.add_subplot(2, 1, 1)
...
# root.update()
# plt.show()
# #   Plot: Pore Size (top), Voltage-time ON SAME graph
# for i,file in enumerate(filenames):
#     dat = LoadData.OpenFile(file)
#     fig1 = plt.figure(1, figsize=(8, 4))
#     ax_part1 = fig1.add_subplot(2, 1, 1)
...
#     # t2 = t/60
#     G = dat['i1']/dat['v1']*1e9
#     size = (G+np.sqrt(G*(G+16*24/np.pi)))/(2*24)
#     ax_part1.plot(t, size)  #dat['i1']/dat['v1']*1e9 or #size
#
#     # ax_part1.set_xlabel('Time (s)')
#     ax_part1.set_ylabel('Pore size (nm)')
#     fig2 = plt.figure(1, figsize=(8, 4))
#     ax_part2 = fig1.add_subplot(2, 1, 2, sharex=ax_part1)
#     t = np.arange(len(dat['v1']))/dat['samplerate']
#
...
# #1  Plot 211 and 212 type graph::: Current-time (top), Voltage-time (below), Histogram (Right)
#
#
# for i,file in enumerate(filenames):
#     dat = LoadData.OpenFile(file)
#     fig1 = plt.figure(1, figsize=(8, 4))
#     ax_part1 = fig1.add_subplot(2, 2, 1)
#     t = np.arange(len(dat['i1']))/dat['samplerate']
#     ax_part1.plot(t, dat['i1'] * 1e9)
#     ax_part1.set_ylabel('Ionic Current (nA)')
#     current_array = np.array(dat['i1'] * 1e9)
...
# # ax_part1.set_ylim(-5, 5)
#     fig2 = plt.figure(1, figsize=(8, 4))
#     ax_part2 = fig1.add_subplot(2, 2, 3) #, sharex=ax_part1)
#     t = np.arange(len(dat['v1']))/dat['samplerate']
#     ax_part2.plot(t, dat['v1']*1e3)
# ax_part2.set_xlabel('Time (s)')
# ax_part2.set_ylabel('Voltage (mV)')

...
for filename in filenames:
    data_file = pd.read_excel(filename) #Makesure your readble file 'raman_spectra_1.xlsx'is in the current directory like in my case M Drive, Michael/Jochem can we make this openfile like thingy?
